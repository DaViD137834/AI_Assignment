...
|---|---|---|
| Ambrose Teo Chen Bin | `02_Source_Code/AI_Assignment.ipynb`<br>`03_Dataset/cleaned_dataset.csv`<br>`03_Dataset/IMDBDataset.csv`<br>`02_Source_Code/app.py` | Text preprocessing pipeline (Regex/NLTK), Linear SVM classifier implementation, design streamlit ui and notebook training workflow. |
